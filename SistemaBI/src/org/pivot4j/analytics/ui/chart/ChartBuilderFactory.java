...
public class ChartBuilderFactory
{
  ...
  protected void registerDefaultChartBuilders(Map<String, Class<? extends ChartBuilder>> builders)
  {
    ...
    builders.put(HorizontalBarChartBuilder.NAME, HorizontalBarChartBuilder.class);
    
    builders.put(StackedBarChartBuilder.NAME, StackedBarChartBuilder.class);
    builders.put(StackedAreaChartBuilder.NAME, StackedAreaChartBuilder.class);
  }
  ...
  public <T extends ChartBuilder> T createChartBuilder(String name, FacesContext context)
  {
    T builder = null;
    

    Class<T> implementationType = (Class)this.builders.get(name);
    if (implementationType != null) {
      try
      {
        Constructor<T> constructor = implementationType.getConstructor(new Class[] { FacesContext.class });
      ...
      {
        String msg = "Failed to instantiate the chart builder class : " + implementationType;
